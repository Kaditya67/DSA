...
class LinkedList {   // -....<-Node2<-Node1<-head
private:
...
void LinkedList::append(int value) {
    ...
    if (head == nullptr) {
        ...
        newNode->getPrev() = current;  // Corrected line
    }
}
...
void LinkedList::deleteAt(int position) {
    ...
    deleteNode->getNext()->getPrev()=temp;
    delete deleteNode;
}
